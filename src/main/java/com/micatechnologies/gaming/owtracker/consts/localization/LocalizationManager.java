...
package com.micatechnologies.gaming.owtracker.consts.localization;
...
public class LocalizationManager
{
    ...
    /**
     * The prefix of all error logs that are submitted via {@link Logger#logError(String)}.
     *
     * @since 1.0
     */
    ...
    /**
     * The prefix of all warning logs that are submitted via {@link Logger#logWarning(String)}.
     *
     * @since 1.0
     */
    ...
    /**
     * The prefix of all standard logs that are submitted via {@link Logger#logStd(String)}.
     *
     * @since 1.0
     */
    ...
    /**
     * The prefix of all debug logs that are submitted via {@link Logger#logDebug(String)}.
     *
     * @since 1.0
     */
