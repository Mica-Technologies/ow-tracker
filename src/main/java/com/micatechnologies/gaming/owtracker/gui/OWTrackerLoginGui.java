...
import com.micatechnologies.gaming.owtracker.utilities.AuthUtilities;
...
public class OWTrackerLoginGui extends OWTrackerAbstractGui
{
    /**
     ...
     */
    public OWTrackerLoginGui(Stage stage ) throws IOException {
        super( stage );
    }
     ...
     */
    @SuppressWarnings( "unused" )
    public OWTrackerLoginGui(Stage stage, double width, double height ) throws IOException {
