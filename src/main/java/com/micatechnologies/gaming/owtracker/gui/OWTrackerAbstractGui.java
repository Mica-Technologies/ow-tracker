...
/**
 * Abstract class for JavaFX scenes in the Mica Overwatch Tracker
 *
 * @since 2020.1
 */
public abstract class OWTrackerAbstractGui
{
    /**
     ...
     */
    public OWTrackerAbstractGui(Stage stage ) throws IOException {
     ...
     * @throws IOException if unable to load FXML file specified
     */
    public OWTrackerAbstractGui(Stage stage, double width, double height ) throws IOException {
        GUIUtilities.JFXPlatformRun( () -> {
            try {
                FXMLLoader fxmlLoader = new FXMLLoader();
                URL resource = getClass().getClassLoader().getResource( getSceneFxmlPath() );
