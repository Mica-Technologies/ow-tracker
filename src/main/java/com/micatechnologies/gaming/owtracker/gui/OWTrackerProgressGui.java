...
public class OWTrackerProgressGui extends OWTrackerAbstractGui
{
    /**
     ...
     */
    public OWTrackerProgressGui(Stage stage ) throws IOException {
        super( stage );
    }
     ...
     * @throws IOException if unable to load FXML file specified
     */
    public OWTrackerProgressGui(Stage stage, double width, double height ) throws IOException {
    ...
    public void setUpperLabelText( String text ) {
        GUIUtilities.JFXPlatformRunAsync( () -> upperLabel.setText( text ) );
    }
    ...
    public void setLowerLabelText( String text ) {
        GUIUtilities.JFXPlatformRunAsync( () -> lowerLabel.setText( text ) );
    }
    ...
    public void setProgress( double progress ) {
        ...
        // Update progress bar
        GUIUtilities.JFXPlatformRunAsync( () -> {
